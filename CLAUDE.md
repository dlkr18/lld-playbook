...
1. **Java LLD playbook** (`src/`) — ~52 self-contained low-level-design problems, each a mini-codebase demonstrating specific patterns. This is the core; most work happens here.
