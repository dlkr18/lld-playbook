...
|-------|-------|-----------|----------------|
| **LLD Process** | [Day 1 Guide](docs/foundations/DAY1_LLD_PROCESS.md) | [Exercises](docs/foundations/EXERCISES.md) | [Visual Flow](docs/foundations/diagrams/lld-process-flow.png) |
