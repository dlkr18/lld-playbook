...
classDiagram
    ...
    class ElevatorController {
        ...
        +getStatus(elevatorId) ElevatorStatus
    }
    ...
    class OptimalElevatorController {
        ...
        +requestElevator(floor, direction)
        +selectOptimalElevator(request) Elevator
        +assignRequest(elevator, request)
    }
    
    class ElevatorScheduler {
        <<interface>>
        +getNextRequest(elevator, requests) Request
    }
    ...
    ElevatorController <|.. OptimalElevatorController
    OptimalElevatorController --> Elevator
    OptimalElevatorController --> ElevatorScheduler
    ElevatorScheduler <|.. SCANScheduler
    ElevatorScheduler <|.. LOOKScheduler
    Elevator --> Direction
    Elevator --> ElevatorStatus
    Elevator --> Request
    OptimalElevatorController --> ElevatorMetrics
```
</details>
