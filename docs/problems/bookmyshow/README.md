...
classDiagram
    ...
    class BookingNotFoundException {
        -String message
        -Throwable cause
        +BookingNotFoundException(message)
        +getMessage() String
    }
    ...
    class SeatNotAvailableException {
        -String message
        -Throwable cause
        +SeatNotAvailableException(message)
        +getMessage() String
    }
    ...
    BookingServiceImpl --> City
    BookingServiceImpl --> Language
    BookingServiceImpl "1" --> "*" Seat
    BookingServiceImpl --> Payment
    Movie --> Language
    Movie --> Genre
    Booking --> User
    Booking --> Show
