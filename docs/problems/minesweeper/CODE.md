...
> Generated from `src/main/java/com/you/lld/problems/minesweeper/` on 2026-05-31. Re-run `python3 scripts/generate-code-md.py minesweeper`.
...
```bash
mvn -q compile exec:java -Dexec.mainClass="com.you.lld.problems.minesweeper.Demo"
```
