...
> Generated from `src/main/java/com/you/lld/problems/inventory/` on 2026-05-31. Re-run `python3 scripts/generate-code-md.py inventory`.
...
<details>
<summary>Click to view InventoryDemo.java</summary>
