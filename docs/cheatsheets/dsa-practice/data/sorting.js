  ...
  "questions": [
    {
      ...
      "description": "Given input per constraints, solve: Sort an Array.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Kth Largest Element.",
    ...
    },
    {
      ...
      "description": "Count of Smaller Numbers After Self — return the total count satisfying the problem rules.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: H-Index.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Wiggle Sort II.",
    ...
    },
    {
      ...
      "description": "Compute the maximum gap over the given input per constraints.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Relative Sort Array.",
    ...
    },
    {
      ...
      "description": "Return string sorted by character frequency descending.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Custom Sort String.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Valid Triangle Number.",
