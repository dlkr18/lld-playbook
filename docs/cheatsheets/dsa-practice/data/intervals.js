window.PRACTICE_TOPIC = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Insert Interval.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Meeting Rooms.",
    ...
    },
    {
      ...
      "description": "Compute the minimum interval to include each query over the given input per constraints.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Employee Free Time.",
    ...
    },
    {
      ...
      "description": "Intersection of two lists of closed intervals.",
    ...
    },
    {
      ...
      "description": "Design calendar supporting book(start,end) without double booking.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: My Calendar II.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Remove Covered Intervals.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Data Stream as Disjoint Intervals.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Set Intersection Size At Least Two.",
    ...
    },
    {
      ...
      "description": "Compute the maximum number of events over the given input per constraints.",
    ...
    },
    {
      ...
      "description": "Return true if all trips can be completed without exceeding capacity.",
    ...
    },
    {
      ...
      "description": "Given input per constraints, solve: Teemo Attacking.",
      "summary": "Merge sorted — state invariant, then loop."
    },
    {
      "id": "iv-20",
      ...
      "description": "Given input per constraints, solve: Add Bold Tag in String.",
