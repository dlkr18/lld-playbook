...
### **Sequence Diagrams**
![Order Flow](diagrams/sequence-order-flow.jpg)
*Complete order placement and fulfillment flow*

![Reserve-Commit Flow](diagrams/sequence-reserve-commit.jpg)
*Inventory reservation and commitment process*

![Transfer Flow](diagrams/sequence-transfer.jpg)
*Inter-warehouse inventory transfer*

### **State Machine Diagrams**
![Reservation States](diagrams/state-reservation.jpg)
*Inventory reservation lifecycle*

![Order States](diagrams/state-order.jpg)
